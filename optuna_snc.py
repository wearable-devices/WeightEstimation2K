...
def objective(trial):
    ...
    average_sensors_weight_estimation_model_dict = {'window_size_snc': snc_window_size_hp,
                                                    'scattering_type': None,#'SEMG',# trial.suggest_categorical('scattering_type', ['old',  'SEMG', ]),
                                                        'J_snc': 7,
                                                        'Q_snc': (2, 1),
                                                    'undersampling': 3,#trial.suggest_float('undersampling', 2, 4, step=0.2),#4.8,
                                                    'scattering_max_order': 1,
                                                    'units': 11,# trial.suggest_int('units', 4, 12), #9 21 12
                                                    ...
                                                    'use_attention': True,#trial.suggest_categorical('use_attention', [True, False ]),
                                                        ...
                                                        'attention_layers_for_one_sensor':1,# trial.suggest_int('attention_layers_for_one_sensor', 1, 3),#2
    ...
    if create_one_sensor_models:
        ...
        model_1_path = '/home/wld-algo-6/Production/WeightEstimation2K/logs/09-04-2025-11-30-42/trials/trial_1/model_sensor_1.keras'#'/home/wld-algo-6/Production/WeightEstimation2K/logs/03-04-2025-17-45-14/trials/trial_23/model_sensor_1_bestbest.keras'# '/home/wld-algo-6/Production/WeightEstimation2K/logs/21-03-2025-19-20-07/trials/trial_31/model_sensor_1_bestbest18.keras'
        model_2_path = '/home/wld-algo-6/Production/WeightEstimation2K/logs/09-04-2025-11-30-42/trials/trial_1/model_sensor_2.keras'#'/home/wld-algo-6/Production/WeightEstimation2K/logs/03-04-2025-17-45-14/trials/trial_23/model_sensor_2_bestbest.keras'#'/home/wld-algo-6/Production/WeightEstimation2K/logs/21-03-2025-19-20-07/trials/trial_31/model_sensor_2_bestbest19.keras'
        model_3_path = '/home/wld-algo-6/Production/WeightEstimation2K/logs/09-04-2025-11-30-42/trials/trial_1/model_sensor_3.keras'#'/home/wld-algo-6/Production/WeightEstimation2K/logs/03-04-2025-17-45-14/trials/trial_23/model_sensor_3_bestbest.keras'#'/home/wld-algo-6/Production/WeightEstimation2K/logs/21-03-2025-19-20-07/trials/trial_31/model_sensor_3_bestbest13.keras'
        custom_objects = {'SEMGScatteringTransform': SEMGScatteringTransform}
        model_sensor_1 = keras.models.load_model(model_1_path, custom_objects=custom_objects, compile=True, safe_mode=False)
        model_sensor_2 = keras.models.load_model(model_2_path, custom_objects=custom_objects, compile=True, safe_mode=False)
        model_sensor_3 = keras.models.load_model(model_3_path, custom_objects=custom_objects, compile=True, safe_mode=False)

    pre_train_one_sensor_models = False# trial.suggest_categorical('pre_train_one_sensor_models', [True, False])
    if pre_train_one_sensor_models:
    ...
    # save one sensor keras models
    initial_model_path = os.path.join(trial_dir, 'model_sensor_1' + '.keras')
    model_sensor_1.save(initial_model_path, save_format='keras')

    initial_model_path = os.path.join(trial_dir, 'model_sensor_2' + '.keras')
    model_sensor_2.save(initial_model_path, save_format='keras')

    initial_model_path = os.path.join(trial_dir, 'model_sensor_3' + '.keras')
    model_sensor_3.save(initial_model_path, save_format='keras')


    total_params, trainable_params, non_trainable_params = count_parameters(model_sensor_1)
    fuse_models=True
    if fuse_models:
        fusion_type_tp = 'attention_flat'#trial.suggest_categorical('fusion_type', ['attention_mean',  'attention_flat', ])
        fused_layer_name = 'dense_2'# trial.suggest_categorical('fused_layer_name', ['mean_layer', 'dense_1', 'dense_2', 'final_dense_1' ])#'dense_1'#
    ...
    # TEST MODEL or 3 one-sensor models
    ...
    for person in persons_for_test:
        ...
        if fuse_models:
            ...
            model = keras.models.load_model(initial_model_path, custom_objects=custom_objects,
                                               compile=True,
                                               safe_mode=False)
        # else we need to take all one sensor models
        ...
        model_list = [model] if fuse_models else [model_sensor_1, model_sensor_2,model_sensor_3]
        person_mae_list = []
